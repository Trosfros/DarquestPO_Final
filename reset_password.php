              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                    <a href="<?= $domain . "/reset_password_form.php?guid=" . $guid?>" 
                       target="_blank" 
          ...
          <tr>
            <td align="left" style="padding: 20px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666666;">
              ...
              <p style="margin: 10px 0; word-break: break-all;">
                <a href="<?= $domain . "/reset_password_form.php?guid=" . $guid?>" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Confirmer</a>
              </p>
            </td>
          </tr>
